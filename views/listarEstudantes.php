...
<body>
  ...
  <h2>Lista de Estudantes</h2>
   ...
   <div class="search-container">
    ...
    for ($i = 0; $i < 3; $i++) {
        $ano = $anoAtual - $i;
        $selected = ($cursoSerie === (string)$ano) ? 'selected' : '';
        echo "<option value=\"$ano\" $selected>Alunos de $ano</option>";
    }

    $anoLimite = $anoAtual - 2;
    $valorAntes = 'antes' . $anoLimite;
    $selectedAntes = ($cursoSerie === $valorAntes) ? 'selected' : '';
    echo "<option value=\"$valorAntes\" $selectedAntes>Alunos antes de $anoLimite</option>";
    ?>
</select>
